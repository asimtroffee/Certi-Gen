...
export const styles = sortCx({
    ...
    colors: {
        primary: {
            root: [
                "bg-blue-600 text-white shadow-sm ring-1 ring-transparent ring-inset hover:bg-blue-700 data-loading:bg-blue-700",
        ...
        secondary: {
            root: [
                "bg-gray-100 text-gray-900 shadow-sm ring-1 ring-gray-300 ring-inset hover:bg-gray-200 data-loading:bg-gray-200",
                // Icon styles
        ...
        tertiary: {
            root: [
                "text-gray-700 hover:bg-gray-100 hover:text-gray-900 data-loading:bg-gray-100",
                // Icon styles
                "*:data-icon:text-gray-500 hover:*:data-icon:text-gray-700",
            ].join(" "),
        },
